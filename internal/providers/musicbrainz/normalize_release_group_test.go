...
func TestNormalizeReleaseGroupPreservesWorkAndEditionBoundaries(t *testing.T) {
	...
	for provider, want := range map[string]string{"discogs": "24047", "wikidata": "Q173643", "allmusic": "mw0000192938"} {
