...
func validConfig() Config {
	return Config{
		...
		Providers: ProvidersConfig{
			...
			AudioDB:     AudioDBConfig{APIKey: "2", BaseURL: "https://www.theaudiodb.com/api/v1/json", RequestsPerSecond: 0.5},
			Bandcamp:    BandcampConfig{BaseURL: "https://bandcamp.com", PageURLTemplate: "https://{subdomain}.bandcamp.com", RequestsPerSecond: 0.5},
			Deezer:      DeezerConfig{BaseURL: "https://api.deezer.com", RequestsPerSecond: 1},
			Tidal:       TidalConfig{BaseURL: "https://openapi.tidal.com/v2", AuthURL: "https://auth.tidal.com/v1/oauth2/token", Country: "US", RequestsPerSecond: 2},
